...
define('MODULE_PAYMENT_UNIVERSALPAY_TEXT_VOID_ERROR', 'Hubo un problema al anular la transacción.');
define('MODULE_PAYMENT_UNIVERSALPAY_TEXT_REFUND_ERROR', 'Hubo un problema al reembolsar el monto de la transacción especificado.');
define('MODULE_PAYMENT_UNIVERSALPAY_TEXT_REFUNDFULL_ERROR', 'Universalpay rechazó su solicitud de reembolso.');
define('MODULE_PAYMENT_UNIVERSALPAY_TEXT_INVALID_REFUND_AMOUNT', 'Solicitó un reembolso parcial, pero no especificó una cantidad.');
define('MODULE_PAYMENT_UNIVERSALPAY_TEXT_REFUND_FULL_CONFIRM_ERROR', 'Solicitó un reembolso completo pero no marcó la casilla Confirmar para verificar su intención.');
define('MODULE_PAYMENT_UNIVERSALPAY_TEXT_INVALID_AUTH_AMOUNT', 'Solicitó una autorización pero no especificó una cantidad.');
define('MODULE_PAYMENT_UNIVERSALPAY_TEXT_INVALID_CAPTURE_AMOUNT', 'Solicitó una captura pero no especificó una cantidad.');
define('MODULE_PAYMENT_UNIVERSALPAY_TEXT_VOID_CONFIRM_CHECK', 'Confirmar');
define('MODULE_PAYMENT_UNIVERSALPAY_TEXT_VOID_CONFIRM_ERROR', 'Solicitó anular una transacción, pero no marcó la casilla Confirmar para verificar su intención.');
define('MODULE_PAYMENT_UNIVERSALPAY_TEXT_AUTH_FULL_CONFIRM_CHECK', 'Confirmar');
define('MODULE_PAYMENT_UNIVERSALPAY_TEXT_AUTH_CONFIRM_ERROR', 'Solicitó una autorización pero no marcó la casilla Confirmar para verificar su intención.');
define('MODULE_PAYMENT_UNIVERSALPAY_TEXT_CAPTURE_FULL_CONFIRM_ERROR', 'Solicitó la captura de fondos pero no marcó la casilla Confirmar para verificar su intención.');
...
define('MODULE_PAYMENT_UNIVERSALPAY_ENTRY_CAPTURE_ERROR', 'Hubo un problema al capturar la transacción.');
...
define('MODULE_PAYMENT_UNIVERSALPAY_ENTRY_VOID_ERROR', 'Hubo un problema al anular la transacción.');
